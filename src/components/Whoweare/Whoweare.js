    ...
    <div className='wrap'>
        <Fade left>
            <div className="box left">
                ...
                <h1 className='header2'>At <span>Rodeo Recovery Treatment Center,</span> we provide safe and comfortable medical detox services for those struggling with addiction.</h1>
                <br/>
